...
AroTable is a data structure that sorts itself with every manipulation made to it. It runs on the very fast AroSort sorting algorithm, with Big O Notation of O(n) in adding, but a Big O Notation of O(1) in removing and searching!
